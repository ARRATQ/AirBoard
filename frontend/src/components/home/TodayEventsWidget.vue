<template>
  <div class="today-events-widget">
    <!-- Widget Header -->
    <div class="widget-header">
      <div class="header-left">
        <Icon icon="mdi:calendar-today" class="header-icon" />
        <h3 class="widget-title">{{ $t('home.todayEvents.title') }}</h3>
      </div>
    ...
    <div v-if="props.events.length === 0" class="empty-state">
      ...
      <p class="empty-text">{{ $t('home.noEvents') }}</p>
    </div>
